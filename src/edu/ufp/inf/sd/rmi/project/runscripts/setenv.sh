...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/Library/Java/JavaVirtualMachines/jdk1.8.0_211.jdk/Contents/Home
...
#export CURRENT_IDE=¢{NETBEANS}
export USERNAME=andrecorreia

#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=sdproject
export JAVAPROJ=/Users/andrecorreia/iDEAProjects/${JAVAPROJ_NAME}

export PACKAGE=project
export PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
export PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
export SERVICE_NAME_ON_REGISTRY=Service
