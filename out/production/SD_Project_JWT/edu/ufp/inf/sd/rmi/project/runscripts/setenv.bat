...
@REM Date: 20/02/2019
@REM pwd: /Users/rui/Documents/NetBeansProjects/SD/src/edu/ufp/inf/sd/rmi/edu.ufp.inf.sd.rmi.helloworld
...
@Set JAVAPROJ_NAME=SD_Project_JWT
...
@Set JAVA_RABBITMQ_TOOLS=%JAVA_LIB_FOLDER%\\amqp-client-5.7.1.jar;%JAVA_LIB_FOLDER%\\slf4j-api-1.7.26.jar;%JAVA_LIB_FOLDER%\\slf4j-simple-1.7.26.jar;%JAVA_LIB_FOLDER%\\guava-23.0.jar;%JAVA_LIB_FOLDER%\\jjwt-api-0.11.0.jar;%JAVA_LIB_FOLDER%\\jjwt-impl-0.11.0.jar;%JAVA_LIB_FOLDER%\\jjwt-jackson-0.11.0.jar;%JAVA_LIB_FOLDER%\\jackson-annotations-2.9.10.jar;%JAVA_LIB_FOLDER%\\jackson-core-2.9.10.jar;%JAVA_LIB_FOLDER%\\jackson-databind-2.9.10.1.jar;%JAVA_LIB_FOLDER%\\json-20190722.jar;%JAVA_LIB_FOLDER%\\scrypt-1.4.0.jar

@set CLASSPATH=.;%JAVAPROG_CLASSES_FOLDER%;%JAVA_RABBITMQ_TOOLS%
